...
<div class="card" style="width: 20rem;">
  <img class="card-img-top" src="/assets/img/spacer.png" data-src="holder.js/100px180/" alt="Card image cap">
...
{% example html %}
<div class="card">
  <img class="card-img-top" src="/assets/img/spacer.png" data-src="holder.js/100px180/?text=Image cap" alt="Card image cap">
  <div class="card-block">
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
  </div>
</div>
...
<div class="card">
  ...
  <img class="card-img-bottom" src="/assets/img/spacer.png" data-src="holder.js/100px180/" alt="Card image cap">
</div>
{% endexample %}
...
<div class="card card-inverse">
  <img class="card-img" src="/assets/img/spacer.png" data-src="holder.js/100px270/#55595c:#373a3c/text:Card image" alt="Card image">
...
<div class="card-deck">
  <div class="card">
    <img class="card-img-top" src="/assets/img/spacer.png" data-src="holder.js/100px200/" alt="Card image cap">
    <div class="card-block">
      <h4 class="card-title">Card title</h4>
...
<div class="card-columns">
  <div class="card">
    <img class="card-img-top" src="/assets/img/spacer.png" data-src="holder.js/100px160/" alt="Card image cap">
    <div class="card-block">
  ...
  <div class="card">
    <img class="card-img" src="/assets/img/spacer.png" data-src="holder.js/100px260/" alt="Card image">
  </div>
