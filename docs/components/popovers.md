...
<table class="table table-bordered table-striped table-responsive">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>number</td>
      <td>0</td>
      <td>Offset of the popover relative to its target. For more information refer to Popper's <a href="https://popper.js.org/popper-documentation.html#new_Popper_new">offset docs</a>.</td>
    </tr>
  </tbody>
</table>
